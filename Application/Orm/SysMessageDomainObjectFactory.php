...
class SysMessageDomainObjectFactory extends \System\Orm\DomainObjectFactory {

	public function doCreateObject(array $array) {
		$obj= new \Application\Model\SysMessage();

		$obj->setId($array['message_id']);
		$obj->setText($array['message_text']);
		$obj->setDate($array['message_date']);
		$obj->setGroup($array['messageset_id']);
		$obj->setStartShow($array['message_begin']);
		$obj->setStopShow($array['message_end']);
